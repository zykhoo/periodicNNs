    ...
    for epoch in range(num_epoch):        
        ...
        if epoch % 500 == 0 : 
          ...
          print('epoch=',epoch, ' time=', elapsed_time, 
                  ...
                  ' f3=', avg_f3 ,' f4=', avg_f4 , 'num_batches=', num_batches, "obsparam=", net.periods, "periods=", periods.trainable_params[0], 'percent lr=', optimizer.param_groups[0]["lr"])
...
for i in range(5):
  ...
  for ini in initialcon: 
    ...
    results = train(net,name="%s/%s/%s_%s_PINNO" %(loc,s,seed,ini),bs=int(len(wholemat)/5),num_epoch=150001,initial_conditions=initialcon,device=device, wholemat=wholemat,evalmat=evalmat,x0=x0,H0=H0,dim=dim,LR=LR,patience=4000,c1=1,c2=1,c3=1,c4=1,periods=periods)
