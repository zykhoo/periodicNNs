    ...
    for epoch in range(num_epoch):        
        ...
        if epoch % 500 == 0 : 
          ...
          print('epoch=',epoch, ' time=', elapsed_time, 
                  ...
                  ' f3=', avg_f3 ,' f4=', avg_f4 , 'num_batches=', num_batches, "alpha", net.alpha, "periods", net.periods, "periods=", periods.trainable_params[0], 'percent lr=', optimizer.param_groups[0]["lr"])
